  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="w-full flex flex-col items-center py-15 gap-10">
        ...
        <div className="grid grid-cols-6 font-medium text-[16px] gap-6">
      ...
      <div className="w-full py-15">
        <div className="w-full grid grid-cols-6 py-15 bg-gray-100 px-10 rounded-3xl">
          {brands.map((brand) => (
            <div key={brand.id} className="w-full h-[60px] relative">
              <Image
                src={brand.src}
                alt={`${brand.id} - image`}
                fill
